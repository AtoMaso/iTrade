export let CONFIG = {
  ...
  alltradesbytraderidwithstatus: 'http://localhost:5700/api/trades/GetAllTradesByTraderIdWithStatus',
  alltradesbytraderid: 'http://localhost:5700/api/trades/GetAllTradesByTraderId',
