...
export class AuthCheck extends RouterOutlet {
  ...
  constructor(_elementRef: ViewContainerRef,
                  _loader: ComponentFactoryResolver,
                  _parentRouter: Router, @Attribute('name') nameAttr: string,
                 _changeDetectorRef: ChangeDetectorRef) {

    super(null, _elementRef, _loader, name, _changeDetectorRef); // check the last argument is tem there for the moment
     //super(_elementRef, _loader, _parentRouter, nameAttr);     the old one 
